...
### **NVIDIA Onyx Switch 2G Shell**
The **NVIDIA Onyx Switch 2G** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the **NVIDIA Onyx Switch**. 

For more information on the **NVIDIA Onyx Switch**, see the official **NVIDIA** product documentation.

### Standard version
**NVIDIA Onyx Switch 2G Shell** is based on the Networking Shell Standard version **5.0.2**.
...
Release: **NVIDIA Onyx Switch 2G Shell**
...
#### **NVIDIA Onyx Switch 2G Shell Families and Models**

The NVIDIA Onyx Switch families and models are listed in the following table:

|Family|Model|Description|
|:---|:---|:---|
|CS_Switch|NVIDIA Onyx Switch 2G|Generic NVIDIA Onyx Switch 2 Generation |
...
#### **NVIDIA Onyx Switch 2G Shell Attributes**
...
The following resource commands are available on the **NVIDIA Onyx Switch**:
...
The **NVIDIA Onyx Switch 2G Shell** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|NVIDIAOnyxSwitchShell2G.zip |NVIDIA Onyx Switch shell package|
|cloudshell-networking-nvidia-onyx2gen-dependencies-package1.0.X.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **NVIDIA Onyx Switch 2G Shell** shell and configure and modify the shell’s devices.
...
1. Download the *cloudshell-networking-nvidia-onyx2gen-dependencies-package1.0.X.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **NVIDIA Onyx Switch 2G**.
  
  3. Enter the **Name** and **IP address** of the **NVIDIA Onyx Switch**.
  
  4. Click **Create**.
  
  5. In the **Resource** dialog box, enter the device's settings, see [NVIDIA Onyx Switch 2G Shell Attributes](#nvidia-onyx-switch-2g-shell-attributes). Make sure you enter the device's SNMP version and credentials.
...
1. In CloudShell Portal, add the **NVIDIA Onyx Switch** resource to your blueprint and reserve the blueprint.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/NVIDIA-Onyx-Switch-Shell-2G/releases).
